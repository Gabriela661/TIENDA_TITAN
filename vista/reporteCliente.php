            ...
            <div class="content-wrapper" style="font-family: 'Open Sans', sans-serif;">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h4><i class="fa fa-briefcase mr-3" aria-hidden="true"></i><b>Reporte de Clientes</b></h4>
                                <div class="container">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            &nbsp; <a type="button" class="btn btn-danger" href="#" id="generatePDFCus"><i class="far fa-file-pdf"></i></a>
                                            &nbsp;&nbsp;&nbsp;
                                            <button class="btn btn-primary">
                                                <i class="fa fa-user"></i> Total de Clientes
                                                <span class="badge bg-color6 text-c2" id="totalClientes"></span>
                                            </button>
                                        </div>
                                    </div>
                                </div>
