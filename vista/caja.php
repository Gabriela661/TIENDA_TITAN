...
<div class="wrapper">
    ...
    <!-- inicio Modal  crear movimiento caja-->
    <div class="modal fade" id="crearcaja" tabindex="-1" role="dialog" aria-labelledby="#crearcaja" aria-hidden="true">
    ...
    <div class="content-wrapper" style="font-family: 'Open Sans', sans-serif;">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2 p-2 d-flex sm:flex-row justify-content-between align-items-center">
                    <div class="col-md-4">
                        <h4><i class="fas fa-users"></i> <b>Movimientos de caja</b></h4>
                    </div>
                    <div class="col-md-4 row d-flex align-items-center justify-content-between m-2">
                        <div class="md-col-4 mb-2"><button type="button" class="btn btn-primary ml-3" data-toggle="modal" data-target="#crearcaja">
                                <i class="fa fa-plus"></i> movimiento</button></div>
                        <!-- <a id="diaCaja" type="button" href="#" class="btn btn-primary d-flex align-items-center">Día</a>&nbsp;&nbsp;<p><span id="totalDiaCaja"></span></p>
                            <a id="mesCaja" type="button" href="#" class="btn btn-success d-flex align-items-center">Mes</a>&nbsp;&nbsp;<span id="totalMesCaja"></span> -->
                        <div class="col-md-6 d-flex justify-content-end align-items-center" id="cajaTotal">
