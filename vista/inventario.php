          ...
          <form action="/submit" id="form_inventario" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
              ...
              <!--  <div class="form-group">
                ...
                <center>
                  <div id="imagen_preview1" style="margin-top: 10px;" class="img-thumbnail"></div>
                </center>
              </div>
              <div class="form-group">
                <label for="imagen_secundaria_1_producto">Imagen secundaria 1 de Producto</label>
                <br>
                <input type="file" name="imagen_secundaria_1_producto" id="imagen_secundaria_1_producto" accept="image/jpg, image/jpeg, image/png">
                <center>
                  <div id="imagen_preview2" style="margin-top: 10px;" class="img-thumbnail"></div>
                </center>
              </div>
              <div class="form-group">
                <label for="imagen_secundaria_2_producto">Imagen secundaria 2 de Producto</label>
                <br>
                <input type="file" name="imagen_secundaria_2_producto" id="imagen_secundaria_2_producto" accept="image/jpg, image/jpeg, image/png">
                <center>
                  <div id="imagen_preview3" style="margin-top: 10px;" class="img-thumbnail"></div>
                </center>
              </div>
              <div class="form-group">
                <label for="imagen_secundaria_3_producto">Imagen secundaria 3 de Producto</label>
                <br>
                <input type="file" name="imagen_secundaria_3_producto" id="imagen_secundaria_3_producto" accept="image/jpg, image/jpeg, image/png">
                <center>
